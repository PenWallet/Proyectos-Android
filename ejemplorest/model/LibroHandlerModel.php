...
//            }
    ...
    public static function insertLibro($libro)
    {
        ...
        //If the $id is valid or the client asks for the collection ($id is null)
        if ($libro instanceof LibroModel)
        {
            $query = "INSERT INTO libros (".\ConstantesDB\ConsLibrosModel::TITULO.", ".\ConstantesDB\ConsLibrosModel::PAGS.") VALUES (?. ?)";
            ...
            $prep_query->bind_param('s', $libro->getTitulo());
            $prep_query->bind_param('i', $libro->getNumpag());
